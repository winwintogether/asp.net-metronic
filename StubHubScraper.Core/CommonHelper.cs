...
using StubHubScraper.Core.ComponentModel;

namespace StubHubScraper.Core
{
    /// <summary>
    ...
    public partial class CommonHelper
    {
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new ApplicationException(string.Format("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType));
            if (!pi.CanWrite)
                throw new ApplicationException(string.Format("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType));
